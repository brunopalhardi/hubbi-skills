...
O kit da consultoria do [Bruno Palhardi](https://hubbi.solutions/bruno):
skills em português que deixam o Claude Code pronto para quem **nunca
programou** — empresários e profissionais que querem usar IA no dia a dia.
...
```
/plugin marketplace add brunopalhardi/hubbi-skills
...
## Bônus: seu VS Code com a cara do do Bruno

O arquivo [`ambiente/configurar-vscode.md`](ambiente/configurar-vscode.md)
é um doc que você manda pro Claude e ele configura tudo sozinho: tema,
fonte, interface limpa e a barra de status que mostra modelo, uso e limites.

---

Feito para os mentorados da consultoria. Dúvidas: [hubbi.solutions/bruno](https://hubbi.solutions/bruno)
